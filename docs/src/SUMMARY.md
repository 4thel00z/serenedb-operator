...
- [Running a server](guide/server.md)
...
- [SereneDB](reference/serenedb.md)
- [Database](reference/database.md)
- [DatabaseRole](reference/databaserole.md)
- [ServerSecret](reference/serversecret.md)
- [Backup](reference/backup.md)
- [ScheduledBackup](reference/scheduledbackup.md)
- [Objects the operator creates](reference/objects.md)
- [Differences from the Helm chart](reference/helm-differences.md)
